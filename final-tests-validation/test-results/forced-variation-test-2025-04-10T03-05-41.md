...
```
Forced variation precedence not respected. Expected 'control', got 'undefined'
```
...
```
One or more tests failed to handle invalid forced variations gracefully
```
