...
/**
 * Fastly-specific implementation of IResponseAdapter.
 * Provides a wrapper around Fastly Compute@Edge response functionality.
 */
export class FastlyResponseAdapter implements IResponseAdapter {
  ...
  /**
   * Creates and returns a Response object for Fastly Compute@Edge.
